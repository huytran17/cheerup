...
import makeGetHighlightPost from "../../../../use-cases/post/get-highlight-post";
...
describe("highlightPost", () => {
  ...
  it("should return a body that contains an post entity", async () => {
    ...
    const getHighlightPost = makeGetHighlightPost({ postDb, logger });
    ...
    const result = await hightlightPostController(request as any);
